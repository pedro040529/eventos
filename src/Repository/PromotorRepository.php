...
/**
 * @extends ServiceEntityRepository<Promotor>
 *
...
class PromotorRepository extends ServiceEntityRepository
{
    ...
    public function save(Promotor $entity, bool $flush = false): void
    {
    ...
    public function remove(Promotor $entity, bool $flush = false): void
    {
