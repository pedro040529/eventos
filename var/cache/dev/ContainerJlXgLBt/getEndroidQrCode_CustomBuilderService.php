 ...
 */
class getEndroidQrCode_CustomBuilderService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'endroid_qr_code.custom_builder' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['endroid_qr_code.custom_builder'] = $instance = new \Endroid\QrCode\Builder\Builder();

        $instance->writer(($container->privates['Endroid\\QrCode\\Writer\\SvgWriter'] ??= new \Endroid\QrCode\Writer\SvgWriter()));
