...
class getKnpSnappy_ImageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['knp_snappy.image'] = $instance = new \Knp\Snappy\Image($container->getEnv('WKHTMLTOIMAGE_PATH'), $container->parameters['knp_snappy.image.options'], []);

        $instance->setLogger(($container->privates['monolog.logger.snappy'] ?? $container->load('getMonolog_Logger_SnappyService')));
        $instance->setTemporaryFolder(($container->targetDir.''.'/snappy'));
